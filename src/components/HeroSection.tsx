      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 text-white mt-20 md:mt-0">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 animate-fadeIn">
            Innovate Your <span className="text-accent-400">Digital Presence</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-200 mb-10 animate-fadeIn animation-delay-300">
            We craft beautiful, high-performing digital solutions that help businesses stand out and succeed in today's competitive landscape.
          </p>
